    ...
    <div>
      <transition name="slide-left">
        <div v-if="leftStarted" class="fixed inset-0 z-40 flex w-64  items-center justify-left">
          ...
          <div @click.stop class="bg-gray-700 text-white  pl-3 pt-4 w-59 h-[98%] rounded shadow-lg relative">
            <!-- <button @click="toggleMenu" class="absolute top-0 right-0 mt-3 mr-4">X</button> -->
            <ul>
                
                <li class="flex" @click="toggleMenu">
                ...
                <li class="text-xl py-5 border-b-1 border-t-1 border-black-500 pt-3">
                  <!-- <button id="toggleButton" @click="toggleList">{{ selectedItem }}</button> -->
                  <div class="flex " @click="toggleList">
                    ...
                    <nuxt-link class="flex items-center gap-2 pl-12"  @click="toggleList">
                      <img :src="selectedItem.image" :alt="selectedItem.alt" class="w-6 h-5 " />
                  ...
                  <ul ref="list" id="myList" :class="{'hidden': isHidden}" @click="selectItem">
                    ...
                    <li v-for="item in filteredItems" :key="item.id" @click="handleClick(item)" 
                                               class="hover:bg-gray-900 cursor-pointer px-4 py-2 pl-15">
                ...
                <li class="text-xl py-5 inline-block" @click="toggleMenu">
                  <nuxt-link class="flex items-center gap-2 p-0" tag="button" to="/Fanossoura"  >
                    <div class="flex justify-center items-center">
                    <Icon name="flowbite:book-open-outline"  size="150%" />
                    </div>
                    <span class="pl-3"> Bibliotheque</span>
                  </nuxt-link>               
                </li>

                <li class="text-xl py-4 inline-block pb-3" @click="toggleMenu">
                ...
                <li class="text-xl py-4 -mx-2 " @click="toggleMenu">
                  <nuxt-link class="flex items-center gap-2 p-0" tag="button" to="/Fanossoura"  >
                    <div class="flex justify-center items-center pt-1">
                ...
                <li class="text-xl py-3 " @click="toggleMenu">
                ...
                <li class="text-l py-3 " @click="toggleMenu">
